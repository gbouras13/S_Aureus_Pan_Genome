...
#SBATCH --job-name=s_aureus_insertion_ncbi
#SBATCH --mail-user=george.bouras@adelaide.edu.au
#SBATCH --mail-type=BEGIN
#SBATCH --mail-type=END
#SBATCH --mail-type=FAIL
#SBATCH --err="s_aureus_insertion_ncbi.err"
#SBATCH --output="s_aureus_insertion_ncbi.out"
...
snakemake -c 1 -s runner.smk --use-conda --config Assemblies=/hpcfs/users/a1667917/s_aureus/total_fastas  Output=/hpcfs/users/a1667917/s_aureus/MLST_ncbi  
